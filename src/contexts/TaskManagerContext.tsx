...
const initialState: AppState = {
  ...
  },
  {
    ...
    description: "Thiết kế mockup trang dashboard với Figma",
    status: "doing",
    priority: "medium",
    type: "ui",
    dueDate: "2025-01-22",
  ...
  {
    id: "6",
    title: "Viết test tự động cho module giỏ hàng",
    description: "Sử dụng Jest để viết unit test và integration test",
    status: "todo",
    priority: "high",
    type: "testing",
    dueDate: "2025-01-23",
    estimatedHours: 6,
    tags: ["testing", "jest", "cart"],
  ...
  },
  {
    ...
    description: "Dùng GitHub Actions để tự động build và deploy",
    status: "doing",
    priority: "high",
    type: "devops",
    dueDate: "2025-01-21",
  ...
  {
    id: "8",
    title: "Tích hợp thanh toán với Stripe",
    description: "Thêm phương thức thanh toán Stripe cho website",
    status: "todo",
    priority: "medium",
    type: "feature",
    dueDate: "2025-01-28",
  ...
  {
    id: "9",
    title: "Phân tích log server",
    description: "Sử dụng ELK stack để phân tích log và cảnh báo",
    status: "done",
    priority: "low",
    type: "monitoring",
    dueDate: "2025-01-12",
